...
<a name="A.3"></a>**Come posso seguire un'assemblea?**  
...
Un emendamento deve essere presentato da un singolo congressista(non sono ammessi autori multipli) con un'iniziativa di tipo "Congresso Nazionale - Emendamento"indicando nel titolo "Emendamento a Mozione Generale/Particolare #<n> - «descrizione»". Ciascun congressistapuò presentare più di una proposta, anche complessiva, di emendamento a ciascuna mozione.  
...
Su ciascunemendamento la Presidenza ammette una dichiarazione di voto favorevole ed una contraria, della durata di 2 minuti ciascuna.  
...
Alla fine della fase di dibattito la segreteria inserisce in agoràtutte le mozioni con policy "Congresso Nazionale - Mozione Generale - Votazione" e "Congresso Nazionale - Mozione Particolare - Votazione" dando modo ai congressisti di votare per ciascuna in un tempo limitato.  
...
<a name="B.2"></a>**Quali sono le mansioni della moderazione?**  
...
Nella stanza che vienetrasmessa in streaming ha poteri di moderazione.  
